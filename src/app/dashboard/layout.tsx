...
const SIDEBAR_ITEMS: Record<string, SidebarItem[]> = {
  admin: [
    ...
    { label: "Course Catalog", href: "/dashboard/crs/catalog" },
    { label: "OBE Mapping", href: "/dashboard/crs/obe" },
    { label: "Attendance Reports", href: "/dashboard/faculty/attendance" },
    { label: "Master Timetable", href: "/dashboard/admin/timetable" },
    { label: "Exams & Scheduling", href: "/dashboard/admin/exams" },
  ...
  faculty: [
    ...
    { label: "My Timetable", href: "/dashboard/faculty/timetable" },
    { label: "Enter Marks", href: "/dashboard/faculty/marks" },
    { label: "Evidence Vault", href: "/dashboard/vault" },
  ],
  student: [
    ...
    { label: "My Profile", href: "/dashboard/profile" },
    { label: "Course Catalog", href: "/dashboard/crs/catalog" },
    { label: "Register Courses", href: "/dashboard/crs/register" },
    { label: "OBE Mapping", href: "/dashboard/crs/obe" },
    { label: "My Attendance", href: "/dashboard/student/attendance" },
    { label: "My Timetable", href: "/dashboard/student/timetable" },
